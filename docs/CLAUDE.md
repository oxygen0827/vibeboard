...
├── deploy/Dockerfile               # Node 20 build → nginx:alpine, port 4100
├── deploy/docker-compose.yml       # network_mode: host
└── deploy/nginx.conf               # SPA routing + proxy /compile → 127.0.0.1:8760
```
